...
(() => {
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // Content stored in the sidecar may come from outside the canvas, so
      // only accept data:image/ URLs from it. The `src` attribute is supplied
      // by the page markup and passes through unchanged.
